...
@dataclass
class SequentialToolExecutionState:
    pass


@dataclass
class ExecuteToolCallsState(SequentialToolExecutionState):
...
@dataclass
class RespondWithTextState(SequentialToolExecutionState):
    message: AIMessage
...
@dataclass
class ExecuteNextToolAction(_ActionInterface):
    pass
